...
import { Sparkles, Dumbbell, Waves as WavesIcon, Activity, Utensils, Wine, Coffee, Clock, Car, Plane, Car as CarIcon, MapPin, Waves, Users, Music, BookOpen } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Sparkles key={0} />, <Dumbbell key={1} />, <WavesIcon key={2} />, <Activity key={3} />],
